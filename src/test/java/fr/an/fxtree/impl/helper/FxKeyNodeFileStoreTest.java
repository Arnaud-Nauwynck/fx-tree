...
public class FxKeyNodeFileStoreTest {
    ...
    public void testPut_get_remove_reload() {
        ...
        FxIntNode value123 = objNode.put("value123", 123, TST_loc);
        sut.put("key1", value123);
        
        FxObjNode obj1 = objNode.putObj("obj1", TST_loc);
        obj1.put("field1", "value1", TST_loc);
        sut.put("key2", obj1);
        ...
        FxMemRootDocument tmpDoc = FxMemRootDocument.newInMem();
        ...
        IFxKeyNodeStore sutReload = new FxKeyNodeFileStore(sut.getStoreFile());
